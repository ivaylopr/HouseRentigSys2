        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "User Identityfier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "House identitfier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "House image"),
                    PricePerMonth = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "House renting price for month"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Category indentifier"),
